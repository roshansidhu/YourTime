    ...
    <SafeAreaView style={styles.safeAreaView}>
      ...
      <View style={styles.settingInputWrapper}>
        ...
        <View style={styles.inputHorizontalButtonWrapper}>
          {/* Dark style button */}
          <TouchableOpacity testID="darkModeButton" style={styles.settingLeftButton} onPress={setDarkStyle}>
            <Text style={styles.signInText}>Set Dark Mode</Text>
          </TouchableOpacity>
          {/* Light style button */}
          <TouchableOpacity testID="lightModeButton" style={styles.settingRightButton} onPress={setLightStyle}>
            <Text style={styles.signInText}>Set Light Mode</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.inputHorizontalButtonWrapper}>
          {/* Off Bg Music */}
          <TouchableOpacity testID="offMusicButton" style={styles.settingLeftButton} onPress={offBgMusic}>
            <Text style={styles.signInText}>Off Music</Text>
          </TouchableOpacity>
          {/* On Bg Music */}
          <TouchableOpacity testID="onMusicButton" style={styles.settingRightButton} onPress={onBgMusic}>
  ...
  return (
    <SafeAreaView style={styles.safeAreaView}>
      ...
      <View style={styles.inputWrapper}>
        ...
        />
        {/* Sign In button */}
        <TouchableOpacity testID="signInButton" style={styles.signInButton} onPress={signInSupabase}>
...
export {PomodoroTimer, BottomNavigation, WelcomePage, RegistrationPage, SignInPage, Setting, AllTasks, MyDay, AllProjectsPage};
